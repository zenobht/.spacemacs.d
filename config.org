  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package evil
      ...
      :bind (:map evil-normal-state-map
                  ...
                  ("s-;" . spacemacs/evil-search-clear-highlight)
...
* Others
  #+BEGIN_SRC emacs-lisp
    ...
    (global-set-key [?\s-e] 'evil-escape)
    ...
    ;; minimize creating new buffer in dired mode
    (define-key dired-mode-map (kbd "f") 'dired-find-alternate-file) ; was dired-advertised-find-file
    (define-key dired-mode-map (kbd "F") (lambda () (find-alternate-file ".."))) 
