...
(custom-theme-set-faces
 ...
 `(ivy-minibuffer-match-face-1 ((t (:inherit default :foreground ,face4))))
 `(ivy-minibuffer-match-face-2 ((t (:inherit default :foreground ,face4))))
 `(ivy-minibuffer-match-face-3 ((t (:inherit default :foreground ,face4))))
 `(ivy-minibuffer-match-face-4 ((t (:inherit default :foreground ,face4))))
 `(swiper-line-face ((t (:background ,face5 :foreground ,fullBlack))))
 ...
 `(ivy-modified-buffer ((t (:inherit default :foreground ,face6))))
  ...
  `(company-echo-common ((t (:foreground ,face4))))
  ...
  `(company-tooltip-common ((t (:foreground ,face4))))
